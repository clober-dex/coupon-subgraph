...
export function createAssetRegisteredEvent(asset: Address): AssetRegistered {
  let assetRegisteredEvent = changetype<AssetRegistered>(newMockEvent())

  assetRegisteredEvent.parameters = new Array()

  assetRegisteredEvent.parameters.push(
...
export function createPositionUpdatedEvent(
  ...
  positionUpdatedEvent.parameters.push(
    new ethereum.EventParam(
      "expiredWith",
      ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(expiredWith))
    )
  )
